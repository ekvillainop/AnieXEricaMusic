...
API_ID = int(getenv("API_ID","27866833"))
API_HASH = getenv("API_HASH","be2f62ec74e396bdd081f2d1fa5e8663")
BOT_TOKEN = getenv("BOT_TOKEN","")
MONGO_DB_URI = getenv("MONGO_DB_URI", "")
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "9999"))
LOGGER_ID = int(getenv("LOGGER_ID", "--1002091991816"))
BOTADDLOGS = int(getenv("BOTADDLOGS", "--1002091991816")) # LOGGER_ID Id Also Use No Problem
GBAN_LOGS = int(getenv("GBAN_LOGS", "--1002091991816"))
GCAST_USERS = list(map(int, getenv("GCAST_USERS", "6562606812").split()))
OWNER_ID = int(getenv("OWNER_ID", 6562606812))
OWNER = int(getenv("OWNER", 6562606812))
OWNER_USERNAME = getenv("OWNER_USERNAME","Nobi7a")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/ekvillainop/AnieXEricaMusic")
